...
test.skip('Test #1 - List user transactions', () => {});

test.skip('Test #2 - Insert user transactions', () => {});

describe('Test #3 - Validation of transaction creation', () => {
  test.skip('Test #3.1 - Insert transaction without Date', () => {});

  test.skip('Test #3.2 - Insert transaction without Category', () => {});

  test.skip('Test #3.3 - Insert transaction without Ammount', () => {});
});
